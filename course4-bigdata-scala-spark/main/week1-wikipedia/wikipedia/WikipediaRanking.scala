...
object WikipediaRanking extends WikipediaRankingInterface {
  ...
  def rankLangsReduceByKey(langs: List[String], rdd: RDD[WikipediaArticle]): List[(String, Int)] =
    makeIndex(langs, rdd).reduceByKey((_, v) => v).mapValues(_.size).collect.toList.sortBy(_._2)(Ordering.Int.reverse)
...
// RESULT ANALYSIS
// Processing Part 1: naive ranking took 77968 ms.
// Processing Part 2: ranking using inverted index took 38482 ms.
// Processing Part 3: ranking using reduceByKey took 27902 ms.